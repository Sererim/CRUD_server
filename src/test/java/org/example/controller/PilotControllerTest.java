...
import org.example.controllers.PilotController;
...
class PilotControllerTest {
  ...
  void doGetTest() throws Exception {
    ...
    pilotController.doGet(request, response);
  ...
  void doPostTest() throws Exception {
    ...
    pilotController.doPost(request, response);
  ...
  void doPutTest() throws Exception {
    ...
    pilotController.doPut(request, response);
  ...
  void doDeleteTest() throws Exception {
    ...
    pilotController.doDelete(request, response);
